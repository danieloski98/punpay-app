    ...
    <Box backgroundColor="mainBackground" flex={1} style={{ paddingHorizontal: 20 }}>
      ...
      <View>
        <View style={Style.box}>
          ...
          <CustomInput name="oldpassword" keyboardType='email-address' leftElement={<Feather name="lock" size={25} style={{ marginTop: 10, color: theme.colors.iconColor }} />} rightElement={<Feather  name={"eye-off"} size={25} style={{ marginTop: 10, color: theme.colors.iconColor }} />} />
        </View>
      </View>
